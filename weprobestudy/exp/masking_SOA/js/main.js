...
const force_choice_first = {
  ...
  stimulus: () => {
    ...
    const SOA = jsPsych.timelineVariable("SOA");

    console.log(section, position, freq, SOA, WPStaircase.get());
...
const staircase_loop_1 = {
  ...
  loop_function: (data) => {
    console.log("Loop Test: " + WPStaircase.isLoop());
